...
function NavBar(){
  ...
  return (
    <div className="flex flex-row mb-16 justify-start">
    ...
    <nav className="justify-start w-full content-center pb-8 pt-8 pl-20 min-[980px]:border-white min-[980px]:border-b-2">
